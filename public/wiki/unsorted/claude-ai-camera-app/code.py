...
class CameraApp:
    ...
    def draw_preview(self):
        ...
        try:
            ...
            if array.shape[2] == 3:  # RGB format
                surface = pygame.surfarray.make_surface(array.swapaxes(0, 1))
            else:  # Handle YUV420 format
                # Simplified conversion - in practice you'd want proper YUV->RGB conversion
                surface = pygame.Surface((320, 240))
                surface.fill(self.GRAY)
            
            # Scale to fit display
            scaled_surface = pygame.transform.scale(surface, (self.DISPLAY_WIDTH, 360))
